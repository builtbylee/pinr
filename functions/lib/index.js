...
exports.appleAuthCallback = exports.exchangeAppleAuthCode = exports.getAppleAuthUrl = exports.fetchActiveGames = exports.rejectReportedPin = exports.approveReportedPin = exports.onReportCreated = exports.moderateImage = exports.adminDeletePin = exports.checkBanStatus = exports.unbanUser = exports.banUser = exports.onWaitlistSignup = exports.createStory = exports.submitChallengeScore = exports.submitGameScore = exports.acceptFriendRequest = exports.removeFriend = exports.addFriend = void 0;
...
async function checkRateLimit(uid, action, config) {
    ...
    try {
        ...
        console.error('[RateLimit] Error checking rate limit:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
...
exports.addFriend = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        console.error('[addFriend] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
...
exports.removeFriend = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        console.error('[removeFriend] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
...
exports.acceptFriendRequest = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        console.error('[acceptFriendRequest] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
...
exports.onWaitlistSignup = functions.firestore
    ...
    if (data.emailSent) {
        ...
        const emailPrefix = email ? ((_a = email.split('@')[0]) === null || _a === void 0 ? void 0 : _a.substring(0, 5)) + '...@***' : 'NULL';
        console.log(`[onWaitlistSignup] Email already sent to ${emailPrefix}, skipping`);
        return;
    }
    const platform = data.platform || 'unknown';
    // Sanitize email in logs
    const emailPrefix = email ? ((_b = email.split('@')[0]) === null || _b === void 0 ? void 0 : _b.substring(0, 5)) + '...@***' : 'NULL';
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    ...
    try {
        ...
        if (!response.ok) {
            ...
            console.error(`[onWaitlistSignup] Resend API error: ${response.status} - ${(errorBody === null || errorBody === void 0 ? void 0 : errorBody.substring(0, 200)) || 'Unknown error'}`);
            return;
        }
        const result = await response.json();
        // Sanitize email and result ID in logs
        const emailPrefix = email ? ((_c = email.split('@')[0]) === null || _c === void 0 ? void 0 : _c.substring(0, 5)) + '...@***' : 'NULL';
        ...
        console.error('[onWaitlistSignup] Failed to send email:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
    }
});
// ============================================
...
exports.banUser = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        console.error('[banUser] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
...
exports.unbanUser = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        console.error('[unbanUser] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
...
exports.checkBanStatus = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const userData = userDoc.data();
        return {
            banned: (userData === null || userData === void 0 ? void 0 : userData.banned) === true,
            message: (userData === null || userData === void 0 ? void 0 : userData.banned) ? 'Your account has been suspended.' : null,
        };
    }
    catch (error) {
        console.error('[checkBanStatus] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
        return { banned: false };
    }
});
/**
...
exports.adminDeletePin = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        console.error('[adminDeletePin] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
...
exports.moderateImage = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        console.error('[moderateImage] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
...
exports.onReportCreated = functions.firestore
    ...
    try {
        ...
        const reporterName = (reporterData === null || reporterData === void 0 ? void 0 : reporterData.displayName) || (reporterData === null || reporterData === void 0 ? void 0 : reporterData.username) || 'Unknown User';
        ...
        if (reportData.reportedPinId) {
            ...
            reportSubject = `🚨 Pin Reported: ${(pinData === null || pinData === void 0 ? void 0 : pinData.title) || 'Untitled'}`;
            reportDetails = `
                    <p><strong>Pin Title:</strong> ${(pinData === null || pinData === void 0 ? void 0 : pinData.title) || 'Untitled'}</p>
                    <p><strong>Pin Location:</strong> ${(pinData === null || pinData === void 0 ? void 0 : pinData.locationName) || 'Unknown'}</p>
                    <p><strong>Pin Creator:</strong> ${(pinData === null || pinData === void 0 ? void 0 : pinData.creatorName) || 'Unknown'}</p>
                `;
            ...
            const userData = userDoc.data();
            reportSubject = `🚨 User Reported: ${(userData === null || userData === void 0 ? void 0 : userData.displayName) || (userData === null || userData === void 0 ? void 0 : userData.username) || 'Unknown'}`;
            reportDetails = `
                    <p><strong>Reported User:</strong> ${(userData === null || userData === void 0 ? void 0 : userData.displayName) || (userData === null || userData === void 0 ? void 0 : userData.username) || 'Unknown'}</p>
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <p style="margin-top: 20px; color: #6B7280; font-size: 14px;">
        ...
        if (!response.ok) {
            const errorBody = await response.text();
            console.error(`[onReportCreated] Email error: ${response.status} - ${(errorBody === null || errorBody === void 0 ? void 0 : errorBody.substring(0, 200)) || 'Unknown error'}`);
            return;
        }
        console.log(`[onReportCreated] Admin notification sent for report ${sanitizedReportId}`);
    }
    catch (error) {
        console.error('[onReportCreated] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
    }
});
/**
...
exports.approveReportedPin = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        console.error('[approveReportedPin] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
...
exports.rejectReportedPin = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        console.error('[rejectReportedPin] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
...
exports.fetchActiveGames = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        console.error('[fetchActiveGames] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
        throw new functions.https.HttpsError('internal', (error === null || error === void 0 ? void 0 : error.message) || 'Failed to fetch games.');
    }
});
// ============================================
...
-----END PRIVATE KEY-----`.trim()
        ...
        console.error('[exchangeAppleAuthCode] Error:', (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error');
        if (error instanceof functions.https.HttpsError) {
            throw error;
        }
        throw new functions.https.HttpsError('internal', (error === null || error === void 0 ? void 0 : error.message) || 'Failed to exchange authorization code');
    }
});
/**
 ...
 */
exports.appleAuthCallback = functions.https.onRequest(async (req, res) => {
    var _a, _b, _c, _d, _e, _f;
    // CRITICAL FIX: Check BOTH body (form_post) and query (GET)
    const code = (((_a = req.body) === null || _a === void 0 ? void 0 : _a.code) || ((_b = req.query) === null || _b === void 0 ? void 0 : _b.code));
    const state = (((_c = req.body) === null || _c === void 0 ? void 0 : _c.state) || ((_d = req.query) === null || _d === void 0 ? void 0 : _d.state));
    const error = (((_e = req.body) === null || _e === void 0 ? void 0 : _e.error) || ((_f = req.query) === null || _f === void 0 ? void 0 : _f.error));
