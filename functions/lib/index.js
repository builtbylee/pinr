...
exports.rejectReportedPin = exports.approveReportedPin = exports.onReportCreated = exports.moderateImage = exports.adminDeletePin = exports.checkBanStatus = exports.unbanUser = exports.banUser = exports.onWaitlistSignup = exports.createStory = exports.submitChallengeScore = exports.submitGameScore = exports.acceptFriendRequest = exports.removeFriend = exports.addFriend = exports.saveiOSAppleAuth = exports.exchangeAppleAuthCode = exports.getAppleAuthUrl = void 0;
...
exports.exchangeAppleAuthCode = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const redirectUri = process.env.APPLE_REDIRECT_URI || ((_d = functions.config().apple) === null || _d === void 0 ? void 0 : _d.redirect_uri) || 'https://getpinr.com/auth/apple/callback';
