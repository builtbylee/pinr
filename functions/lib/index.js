...
exports.rejectReportedPin = exports.approveReportedPin = exports.onReportCreated = exports.moderateImage = exports.adminDeletePin = exports.checkBanStatus = exports.unbanUser = exports.banUser = exports.onWaitlistSignup = exports.createStory = exports.submitChallengeScore = exports.submitGameScore = exports.acceptFriendRequest = exports.removeFriend = exports.addFriend = exports.saveiOSAppleAuth = exports.appleAuthCallback = exports.exchangeAppleAuthCode = exports.getAppleAuthUrl = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
const crypto = __importStar(require("crypto"));
const jwt = __importStar(require("jsonwebtoken"));
const apple_config_1 = require("./apple-config");
// Create APPLE_CONFIG object for use in exchangeAppleAuthCode
const APPLE_CONFIG = {
    APPLE_PRIVATE_KEY: apple_config_1.APPLE_PRIVATE_KEY
};
admin.initializeApp();
...
exports.getAppleAuthUrl = functions.https.onCall(async (data, context) => {
    ...
    const redirectUri = process.env.APPLE_REDIRECT_URI || ((_b = functions.config().apple) === null || _b === void 0 ? void 0 : _b.redirect_uri) || 'https://us-central1-days-c4ad4.cloudfunctions.net/appleAuthCallback';
...
exports.exchangeAppleAuthCode = functions.https.onCall(async (data, context) => {
    ...
    try {
        const teamId = process.env.APPLE_TEAM_ID || ((_a = functions.config().apple) === null || _a === void 0 ? void 0 : _a.team_id) || 'CMBSFLQ5V6';
        const keyId = process.env.APPLE_KEY_ID || ((_b = functions.config().apple) === null || _b === void 0 ? void 0 : _b.key_id) || '8TV72LRP85';
        const clientId = process.env.APPLE_CLIENT_ID || ((_c = functions.config().apple) === null || _c === void 0 ? void 0 : _c.client_id) || 'com.builtbylee.app80days.service';
        const redirectUri = process.env.APPLE_REDIRECT_URI || ((_d = functions.config().apple) === null || _d === void 0 ? void 0 : _d.redirect_uri) || 'https://us-central1-days-c4ad4.cloudfunctions.net/appleAuthCallback';
        // Private key - get from config file, environment, or Firebase config
        let privateKey = APPLE_CONFIG.APPLE_PRIVATE_KEY ||
            process.env.APPLE_PRIVATE_KEY ||
            ((_e = functions.config().apple) === null || _e === void 0 ? void 0 : _e.private_key);
        if (!privateKey) {
            // Fallback: Try to load from local file for deployment convenience if not in env
            try {
                const localConfig = require('./apple-config');
                if (localConfig.APPLE_PRIVATE_KEY)
                    privateKey = localConfig.APPLE_PRIVATE_KEY;
            }
            catch (e) {
                // Ignore
            }
            if (!privateKey) {
                throw new functions.https.HttpsError('failed-precondition', 'Apple Sign-In private key is missing.');
            }
        }
 ...
 */
exports.saveiOSAppleAuth = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
