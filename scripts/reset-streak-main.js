/**
 * Reset explore streak for main account hackneymanlee
 */
...
async function main() {
    ...
    // Query for user with username 'hackneymanlee'
            ...
            structuredQuery: {
                ...
                where: {
                    fieldFilter: {
                        ...
                        op: 'EQUAL',
                        value: { stringValue: 'hackneymanlee' }
                    }
                },
                limit: 1
            }
    ...
    if (!results[0]?.document) {
        console.log('User hackneymanlee not found');
        return;
    }
    ...
    if (updateResp.ok) {
        console.log('✅ Streak reset for hackneymanlee!');
    } else {
